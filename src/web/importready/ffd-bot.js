    ...
    container.innerHTML = `
        ...
        <div class="chatbot-window" id="chatbotWindow" style="display: none">
            <div class="chatbot-header">
                ...
                <span class="chatbot-header-title">FFDBot</span>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const websiteConfig = {
        ffd: {
            botName: 'FFDBot',
            welcomeMessage: 'Hoi! Ik ben je beursassistent voor Flanders Flooring Days. Ik kan je helpen met informatie over vloeren, isolatie en aanverwante producten. Waar ben je naar op zoek?',
        }
    };
    ...
    function initializeWebsite() {
        const config = websiteConfig.ffd;
        if (config) {
    ...
    function addMessage(text, isUser = false) {
        if (isUser) {
            ...
            botName.textContent = websiteConfig.ffd.botName;
