...
[ApiController]
[Route("api/abiss")]
public class AbissController : ControllerBase
{
    private readonly ICosmosDbService _cosmosDbService;
    private readonly IEmbeddingService _embeddingService;
    private readonly ILogger<AbissController> _logger;

    public AbissController(CosmosClient cosmosClient, IEmbeddingService embeddingService, ILogger<AbissController> logger, ILoggerFactory loggerFactory)
    {
        var databaseName = "XpoData";
        var containerName = "abiss";
